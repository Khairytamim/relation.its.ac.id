            ...
            <tbody>
              @foreach($acara as $value)
                <tr>
                  ...
                  <td><a class="btn btn-primary tgl" data-toggle="modal" data-id="{{$value->id_acara}}" data-target="#{{$value->id_acara}}">Edit</a><a class="btn btn-danger" style="margin-left: 10%" data-toggle="modal" data-id="{{$value->id_acara}}" data-target="#b{{$value->id_acara}}">Delete</a></td>
                </tr>
